...
public class Main {
	...
	public static void main(String[] args) {
		...
		//UN progetto che portiamo avanti per qualche lezione
		/*
		    ...
		    crea aereo
		    elimina aereo
		       ovviamente la compagnia aerea predisponde una lista di voli (da, a, orario, nome aereo) utilizzabile per le prenotazioni e per gli imbarchi, e i voli
